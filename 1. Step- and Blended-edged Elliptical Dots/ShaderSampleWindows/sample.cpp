//	Assignment One / Step- and Blended-edged Elliptical Dots
//
...
//  6. The choice of geometry is up to you. Keep it simple at first, then, if there is still time, feel free to get more creative. To try out one of the dragon models, use the GLIB line:
// 		 Obj dragon010.obj
...
const char *WINDOWTITLE = "OpenGL / Step- and Blended-edged Elliptical Dots -- Chiayu Tu";
...
Display( )
{
	...
	Pattern.SetUniformVariable("uDs", NowDs * (float)(.5 + .5 * sin(2. * M_PI * Time)));
	Pattern.SetUniformVariable("uDt", NowDt * (float)(.5 + .5 * cos(2. * M_PI * Time)));
